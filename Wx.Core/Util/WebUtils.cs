    ...
    public sealed class AtWeb
    {
        ...
        public static string Get(string url)
        {
            ...
            try
            {
                ...
                httpWebRequest.UserAgent = @"Mozilla/5.0 (Windows NT 6.3; rv:36.0) Gecko/20100101 Firefox/36.04";
                ...
                StreamReader _sr = new StreamReader(stream);
                return _sr.ReadToEnd();
            }
            catch (Exception e) { Logger.WriteTxtLog(e); }
            finally
            {
        ...
        public static string GetWxOpenid(string p_code)
        {
            string _url = "https://api.weixin.qq.com/sns/jscode2session?appid=wx37f8b9182de4afc0&secret=93d8fd8136e1f780fc2eb68e2a8cb0eb&js_code=" + p_code + "&grant_type=authorization_code";
            return Get(_url);
        }
    }
}
