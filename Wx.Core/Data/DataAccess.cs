...
namespace Wx.Core.Data
{
    public class DataAccess
    {
        ...
        public DataAccess(string p_name)
        {
            string _access = System.AppDomain.CurrentDomain.BaseDirectory;
            if (!_access.EndsWith("\\")) _access += "\\";
